...
class OverdraftBreached(Exception):
    ...
    # breach_amount is referenced in the withdraw method in the CurrentAccount instance
...
# additional attributes could be added later which is why it is good to have a separate file
